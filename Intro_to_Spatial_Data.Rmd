...
proj4string(Ecuador_sp) <- CRS("+proj=utm +zone=18 + south + datum=WGS84")
...
trails_sp <- spTransform(trails_sp, CRS("+proj=utm +zone=18 + south + datum=WGS84"))
...
rio_sp <- spTransform(rio_sp, CRS("+proj=utm +zone=18 + south + datum=WGS84"))
